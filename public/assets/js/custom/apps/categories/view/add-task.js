...
// Class definition
var KTResourcesAddTask = function () {
    // Shared variables
    ...
    var initUpdateTaskStatus = () => {
        const allTaskMenus = document.querySelectorAll('[data-kt-menu-id="kt-resources-tasks"]');

        allTaskMenus.forEach(el => {
            const resetButton = el.querySelector('[data-kt-resources-update-task-status="reset"]');
            const submitButton = el.querySelector('[data-kt-resources-update-task-status="submit"]');
            const taskForm = el.querySelector('[data-kt-menu-id="kt-resources-tasks-form"]');
