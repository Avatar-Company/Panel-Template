...
// Class definition
var KTModalExportResources = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_export_resources');
    const form = element.querySelector('#kt_modal_export_resources_form');
