...
// Class definition
const KTResourcesAddResource = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_add_resource');
    const form = element.querySelector('#kt_modal_add_resource_form');
