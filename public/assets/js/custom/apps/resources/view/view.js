...
// Class definition
var KTResourcesViewMain = function () {
    ...
    // Init sign out single resource
    var initSignOutResource = () => {
        const signOutButtons = document.querySelectorAll('[data-kt-resources-sign-out="single_resource"]');
    ...
    const initDeleteTwoStep = () => {
        const deleteButton = document.getElementById('kt_resources_delete_two_step');
    ...
    const initEmailPreferenceForm = () => {
        // Define variables
        const form = document.getElementById('kt_resources_email_notification_form');
        const submitButton = form.querySelector('#kt_resources_email_notification_submit');
        const cancelButton = form.querySelector('#kt_resources_email_notification_cancel');
